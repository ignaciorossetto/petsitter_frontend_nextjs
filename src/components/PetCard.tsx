...
const PetCard = ({petInfo, handleDeletePetBtn}:CardProps) => {
  ...
  return (
    <div key={petInfo?._id} className={`${petInfo?.sex === 'male' ? 'bg-blue-100' : 'bg-pink-100' }  w-[350px] shadow-2xl p-5 flex flex-col gap-5 items-center`}>
                <div className='relative h-[50%] flex-1'>
                <div className='h-[300px] w-[300px] relative'>
                    <Image src={petInfo?.images[0]} alt='pet-image' fill={true} className='min-w-[300px] min-h-[300px] max-w-[300px] max-h-[300px] object-cover hover:scale-110 duration-200 cursor-pointer rounded-2xl'/>
                ...
                <div className='flex gap-5 justify-center'>
                    ...
                    <div onClick={()=> handleDeletePetBtn(petInfo._id)}>
